...
public:
	enum class Type {
		INTEGER_CONST, REAL_CONST, STRING_CONST, IDENTIFIER, DELIMITER, OPERATOR, WORD
	};

	const std::string TypeToString[7] = { "Integer_const", "Real_const", "String_const", "Identifier", "Delimiter", "Operator", "Word" };
